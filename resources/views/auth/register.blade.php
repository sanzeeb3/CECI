    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Volunteer Form</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('contract_start_date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="contract_start_date" type="date" class="form-control" name="contract_start_date" value="{{ old('contract_start_date') }}" required autofocus>

                                @if ($errors->has('contract_start_date'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('contract_start_date') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('contract_end_date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($errors->has('contract_end_date'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('contract_end_date') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
